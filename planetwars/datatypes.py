...
ImmutablePlanet = namedtuple("ImmutablePlanet", 
                             "id, x, y, owner, ships, growth")
ImmutableFleet = namedtuple("ImmutableFleet", 
                            "owner, ships, source, destination, total_turns, remaining_turns")
